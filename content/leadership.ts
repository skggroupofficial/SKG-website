...
export const leadership = {
  ...
  director: {
    ...
    bio: "Arvind Soni represents the next generation at SKG, working alongside the founding leadership on the firm's active sites — from CCM City Walk through to the ground it takes on next. He carries the same discipline forward: walk the site, know the detail, and stay answerable for it long after handover.",
  },
